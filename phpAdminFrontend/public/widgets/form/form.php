...
?>
<div class="page-title"><?=count($args) ? 'Edit' : 'Add';?> Form</div>
<div class="col-12 col-sm-6 bg-white p-3">
	<form method="post" action="<?=WEB_ROOT;?>/module/save?display=plain" class="bg-white" id="form-form" enctype="multipart/form-data">
		...
		<div class="form-group mb-2">
			<label for="" class="text-required">File</label>
