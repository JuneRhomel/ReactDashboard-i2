...
$fields = rawurlencode(json_encode(["ID" => "id", "Title" => "title", "Content" => "content"]));
...
<script>
	...
	$(document).ready(function() {
		...
		$(".btn-add").off('click').on('click', function() {
			window.location.href = "<?= WEB_ROOT . "/tenant/"; ?>form-add-news";
		});
		$(document).on("click", ".row-id", function() {
			// var data = table.row(this).data();
			var id = $(this).data("id");
			window.location.href = "<?= WEB_ROOT ?>/tenant/view-news/" + id + "/View";
			// console.log(data);
			// alert('div clicked')
		});
