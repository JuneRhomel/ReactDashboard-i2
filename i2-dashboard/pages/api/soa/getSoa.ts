...
import { GetSoaResponse } from "@/types/responseWrapper";

const getSoa = async (req: NextApiRequest, res: NextApiResponse) => {
    ...
    try {
        ...
        const jsonResponse: GetSoaResponse = await response.json()
