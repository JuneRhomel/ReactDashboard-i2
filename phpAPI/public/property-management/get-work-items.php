...
try{
    ...
    $sth = $db->prepare("select work_order.*, users.full_name as created_name 
        ...
        (
            ...
            wo.location, wo.equipment_id, wo.priority_level, wo.service_provider_id, wo.rank, wo.critical, wo.created_by, wo_updates.stage
            ...
            cm.location, cm.equipment_id, cm.priority_level, cm.service_provider_id, cm.rank, cm.critical, cm.created_by, cm_updates.stage
            ...
            pm.location, pm.equipment_id, pm.priority_level, pm.service_provider_id, pm.rank, pm.critical, pm.created_by, pm_updates.stage
