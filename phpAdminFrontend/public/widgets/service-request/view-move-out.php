...
<div class="d-flex justify-content-between mb-3">
	<a onclick="window.location.href = '<?=WEB_ROOT;?>/tenant/service-request?submenuid=service_request'"><label class="data-title"  style="cursor: pointer;"><i class="fa-solid fa-arrow-left text-primary"></i> <?php echo $move_out->tenant_name?></a>
	<?php if($role_access->update == true): ?>
		<a href='<?= WEB_ROOT ?>/tenant/form-edit-move-out/<?= $args[0] ?>/Edit'  class='btn btn-sm btn-primary float-end btn-view-form px-5'>Edit</a>
	<?php endif; ?>
</div>
	<table class="table table-data table-bordered tenant border-table text-capitalize" >
		<tr>
			<th>Type</th><td><?php echo $move_out->sr_type?></td>
		</tr>
		<tr>
			<th>Date Move-Out</th><td><?php echo $move_out->date?></td>
		</tr>
        <tr>
			<th>Requestor Name</th><td><?php echo $move_out->tenant_name?></td>
		</tr>
		<tr>
			<th>Resident Type</th><td><?php echo $move_out->resident_type?></td>
		</tr>
		<tr>
			<th>Unit Number</th><td><?php echo $move_out->unit?></td>
		</tr>
        <tr>
			<th>Contact Number</th><td><?php echo $move_out->contact_num?></td>
		</tr>
	</table>
	...
	<table class="table table-data table-bordered workers border-tabl text-capitalizee" >
		<tr>
			<th>Name</th>
			<th>Description</th>
		</tr>
	...
	<table class="table table-data table-bordered materials border-ta text-capitalizeble" >
		<tr>
			<th>Quantity</th>
			<th>Description</th>
		</tr>
