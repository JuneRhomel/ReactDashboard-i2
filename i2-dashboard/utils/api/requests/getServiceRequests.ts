import { ParamGetServiceRequestsType } from "@/types/models";

const userToken: string = "c8c69a475a9715c2f2c6194bc1974fae:tenant"

/** 
* Fetches the payment details of the user's current SOA.
* @param {ParamGetServiceRequestsType} params - This is a json object that has accountCode, dbTable, queryCondition, and resultLimit
* @return {Promise<Response>} Returns a promise of a Response object.
*/
export async function getServiceRequests(params: ParamGetServiceRequestsType, token: string = "c8c69a475a9715c2f2c6194bc1974fae:tenant"): Promise<Response>{
