						...
						<div class="row">
							<div class="col-12 col-sm-6 mb-3">
								<div class="form-group input-box">
									...
									<label>First Name <b class="text-danger">*</b> <b class="text-warning">^</b></label>
								</div>
							</div>
							<div class="col-12 col-sm-6 mb-3">
								<div class="form-group input-box">
									<input name="last_name" placeholder="Enter here" type="text" class="form-control" value="<?=($record) ? $record->lastname : ''?>" required>
									<label>Last Name<b class="text-danger">*</b> <b class="text-warning">^</b></label>
								</div>
							</div>
							...
							<div class="col-12 col-sm-6 mb-3">
								<div class="form-group input-box">
									...
									<label>Company Name<b class="text-danger">*</b> <b class="text-warning">^</b></label>
								</div>
							</div>
							<?php } ?>
							<div class="col-12 col-sm-6 mb-3">
							...
							<input name="unique" type="hidden" value="company_name,first_name,last_name,email">
						</div>
					</div>
				</div>
			</form>
