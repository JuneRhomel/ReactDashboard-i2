    ...
    return (
      ...
      (n = r
        ...
        : (n =
                    ...
                    case "m":
                      n.push(
                        '<span class="month-label">' +
                          settings.monthMap[t.getMonth() + 1] +
                          "</span>"
                      );
                      break;
                    case "y":
            ...
            (function () {
              const { classes: t, data: e } = settings.customWeekProps(0);
              let n = "";
              Object.keys(e) &&
                ...
                if (settings.dayMap.hasOwnProperty(a)) {
                  ...
                  Object.keys(i) &&
                    ...
                    (s +=
                      ...
                      e +
                      "  >" +
                      ("function" == typeof settings.formatWeekDay
          ...
          t.forEach(function (t, e) {
            const { classes: n, data: a } = settings.customWeekProps(e);
            let s = "";
            Object.keys(a) &&
              ...
              t.forEach(function (t, e) {
                var n = !1,
                  a =
                    ((n = (n = t.getMonth() !== l.getMonth() ? !0 : n)
                      ? " disabled"
                      : ""),
                    !1),
                  a = g && (t == g.toString() || a) ? " selected" : "",
                  s = !1,
                  o =
                    ((s = (s = t == u.toString() ? !0 : s) ? " today" : ""),
                    "ola");
                ((settings.min && settings.min > t) ||
                  ...
                  (settings.disable &&
                    ...
                    settings.disable(t))) &&
                  (o = 'disabled="disabled" ');
                const { classes: i, data: r } = settings.customDateProps(t);
                let c = "";
                Object.keys(r) &&
    ...
    o.html(a(e, t)),
      settings.highlightSelectedWeekday &&
        ...
        o.find(".week").each(function (t, e) {
          s(e)
            .find(".day:eq(" + (n - (settings.startOnMonday ? 1 : 0)) + ")")
            .addClass("highlight");
        })),
  ...
  (s.fn.updateCalendarOptions = function (t) {
    ...
    (s.fn.calendar = function (t) {
      ...
      return (
        ...
        o.off("click", ".day").on("click", ".day", function (t) {
          var e = s(this).data("date");
          "disabled" !== s(this).attr("disabled") && settings.SelectedDay(e);
        }),
        settings.enableMonthChange &&
          ...
          o
            ...
            .on("change", ".months-container .year-dropdown", function (t) {
              var e = s(this).val();
