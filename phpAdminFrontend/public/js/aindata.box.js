  ...
  $.fn.extend({
    JSDataList: function (options) {
          ...
          $.ajax({
            ...
            success: function (json) {
              ...
              $.each(json.data, function () {
                ...
                var dataRow = $("<div>");
                dataRow.addClass("datarow row row-list px-2 py-3");
      ...
      if ($(this).find(".aindata-header").length == 0) {
        ...
        var $ainheader = $("<div>");
        $ainheader.addClass("row aindata-header text-nowrap py-4 px-2");
            ...
            if (column.datatype == "select") {
              ...
              $.each(column.list, function (i) {
                ...
                filterfieldcontainercontent +=
                  ...
                  '<input type="checkbox" class="form-check-input my-2 filters-select" name="' +
                  column.data +
                  '[]" value="' +
                  keyvalue[0] +
                  '"checked>' +
