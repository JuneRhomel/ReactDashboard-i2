...
<div class="main-container">
	<div class="grid lg:grid-cols-1 grid-cols-1 title">
		...
		<form method="post" action="<?php echo WEB_ROOT;?>/property-management/save-record?display=plain" class="bg-white" id="form-wo-save" enctype="multipart/form-data">
				<input type="hidden" name='redirect'  id='redirect' value= '<?= WEB_ROOT?>/property-management/workorder?submenuid=workorder' >
				...
				<div class="row forms">
					...
					<div class="col-12 col-sm-4 my-4">
						<div class="form-group input-box">
							...
							<input id="assigned_personnel_id" type="text" class="form-control" value="<?=$record ? $record['employee_name'] : '';?>" placeholder="Search Building Personnel" required>
						</div>
					</div>
					...
					<div class="col-12 col-sm-4 my-4">
						<div class="form-group input-box">
							...
							<input type="date" class="form-control" name='wo_start_date' required>
						</div>
					</div>
					...
					<div class="col-12 col-sm-4 my-4">
						<div class="form-group input-box">
							...
							<input type="number"  placeholder="Enter Number" class="form-control" name="amount" value="" required>
						</div>
					</div>
...
<script>
	$(document).ready(function(){
		...
		$("#form-wo-save").on('submit',function(e){
			e.preventDefault();
			$.ajax({
