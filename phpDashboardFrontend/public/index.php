...
<html lang="en">
	...
	<div class="main "style="background-color: #FFFFFF;">
        <div class="pb-4" style="background-color: #FFFFFF;">
            ...
            <div class="px-3 py-3" style="margin: 24px 24px; border: 2px solid rgb(213, 215, 217, 0.5); border-radius: 10px;">
                <div>
				...
				<form method="post" action="otp.php">
					...
					<div class="d-flex align-items-center flex-wrap gap-4">
						...
						<!-- <input name="acctdb" type="hidden" value="<?=$acctdb?>"> -->
						<input name="acctcode" type="hidden" value="<?=$acctcode?>">
					</div>

				</form>
                <!-- <div class="text-center" style="padding: 40% 0">
                    <label style="font-size: 16px;">Don't have an account? <a href="#" style="color:#1c5196; font-weight: 600;"><u class="register">Register Now</u></a></label>
                </div> -->
...
$('.bi-eye-slash').on('click', function(){
  ...
  $(".register").click(function(){
	window.location.href = 'http://portali2.sandbox.inventiproptech.com/onboarding-screen.php'
  })
  $('.submit').on('click', function(){
        window.location.href = 'http://portali2.sandbox.inventiproptech.com/otp_new.php';
    });
</script>
