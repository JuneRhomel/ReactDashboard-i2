...
/** 
* Fetches the options for issue categories.
...
*/
export async function getIssueCategories(token: string = "c8c69a475a9715c2f2c6194bc1974fae:tenant", context: any = undefined): Promise<ApiResponse<SelectDataType[]>>{
