	...
	$(document).ready(function() {
		...
		t<?= $unique_id; ?> = $("#jsdata").JSDataList({
			...
			columns: [{
					...
					// 		return '<input type="checkbox" class="checkbox-icon " id="'+ row.id +'" name="check_box" table="unit_repair" view_table="view_unit_repair" reload="<?= WEB_ROOT; ?>/report/sr-summary?submenuid=ss">' + data;							
					// 	}else if(row.sr_type == 'gate-pass'){
					// 		return '<input type="checkbox" class="checkbox-icon " id="'+ row.id +'" name="check_box" table="gate_pass" view_table="view_gate_pass" reload="<?= WEB_ROOT; ?>/report/sr-summary?submenuid=ss">' + data;														
					// 	}else if(row.sr_type ==  'visitor-pass'){
					// 		return '<input type="checkbox" class="checkbox-icon " id="'+ row.id +'" name="check_box" table="visitor_pass" view_table="view_visitor_pass" reload="<?= WEB_ROOT; ?>/report/sr-summary?submenuid=ss">' + data;							
					// 	}else if(row.sr_type == 'reservation'){
					// 		return '<input type="checkbox" class="checkbox-icon " id="'+ row.id +'" name="check_box" table="reservation" view_table="view_reservation" reload="<?= WEB_ROOT; ?>/report/sr-summary?submenuid=ss">' + data;							
					// 	}else if(row.sr_type == 'move-in'){
					// 		return '<input type="checkbox" class="checkbox-icon " id="'+ row.id +'" name="check_box" table="move_in" view_table="view_move_in" reload="<?= WEB_ROOT; ?>/report/sr-summary?submenuid=ss">' + data;							
					// 	}else if(row.sr_type == 'move-out'){
					// 		return '<input type="checkbox" class="checkbox-icon " id="'+ row.id +'" name="check_box" table="move_out" view_table="view_move_out" reload="<?= WEB_ROOT; ?>/report/sr-summary?submenuid=ss">' + data;
					// 	}else if(row.sr_type == 'work-permit'){
					// 		return '<input type="checkbox" class="checkbox-icon " id="'+ row.id +'" name="check_box" table="work_permit" view_table="view_work_permit" reload="<?= WEB_ROOT; ?>/report/sr-summary?submenuid=ss">' + data;							
					// 	}
					// }
				},
				{
