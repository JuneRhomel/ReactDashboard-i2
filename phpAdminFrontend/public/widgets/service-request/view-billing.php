...
$view_soa = $ots->execute('tenant', 'get-record', $data);
$billing = json_decode($view_soa);
// var_dump($billing);
...
$tenants = $ots->execute('tenant','get-records',$data);
$tenant = json_decode($tenants);
var_dump($tenant);
...
<div class="main-container">
    ...
    <table class="table table-data table-bordered tenant border-table text-capitalize">
        <tr>
            <th>Name</th>
            <td><?php echo $tenant[0]->owner_name ?></td>
        </tr>
        <tr>
            <th>Unit Number</th>
        ...
        <tr>
            ...
            <td><?php echo $tenant[0]->owner_spouse ?></td>
        </tr>
