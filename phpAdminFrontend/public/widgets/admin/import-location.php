<?php
$module = "location";
$role_table = "import_location";
$table = "location";
$view = "vw_location";
$error_redirect = "/admin/import-location/";
$unique = ['Location Name'=>'location_name','Location Type'=>'location_type'];
...
$filename = ($ownership=="SO") ? "SO Location Template.xlsx" : "HOA Location Template.xlsx";
?>
