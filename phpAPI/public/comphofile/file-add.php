...
try{
	...
	if(is_array($attachments)) {
		...
		{
			$upload_dir = DIR_ROOT . "/public/uploads/$accountcode/$table/files/";
			...
			$attachments_data = [
				'attachment_url'=> WEB_ROOT . "/uploads/$accountcode/$table/files/$diskname",
			...
			$sth = $db->prepare("insert into {$account_db}.files set " . implode("=?," , array_keys($attachments_data)) . "=?");
