...
<div class="d-flex">
    ...
    <div class="main">
        ...
        <div class="d-flex align-items-end px-3 mt-3">
            ...
            <label class="heading-page px-2 m-0" style="font-weight: 600; font-size: 22px; color: #1C5196;">Move out Form</label>
        </div>

        <div class="px-2" style="background-color: #F0F2F5;  padding: 20px 24px;">
            <div class="d-flex justify-content-end pt-3" style="background-color: #F0F2F5;">
                <div class="card mb-3" style="width: 100%">
                    <div class="mb-0">
                        <button class="d-flex align-items-end justify-content-between btn btn-status w-100" style="padding: 12px;">
                    ...
                    <div id="collapse-status" class="collapse">
                        <form id="frm" name="frm" method="post" enctype="multipart/form-data" action="moveout-save.php">
                            <div class="card-body pt-1">
                                <div class="row forms">
                                    <div class="">
                                        <label class="info-form"><i class="fa-solid fa-circle-info"></i><a href="#"><u>Move out Checklist</u></a></label>

                                        <div class="form-group">
                                            <input placeholder="text" type="text" name="date" required id="request-form" onblur="(this.type='text')" onfocus="(this.type='date')">
                                            <label for="" id="request-form" class="text-required">Date of Move out<span class="text-danger">*</span></label>
                                        </div>
                                    </div>
                                    <div class="">
                                        <div class="form-group">
                                    ...
                                    <div class="terms-condition-text d-flex  gap-2 pt-3" style="margin-bottom: 24px;">
                                        <input placeholder="text" type="checkbox"> Gate pass for moving out Items <span class="text-danger">*</span>
                                    </div>
                                    ...
                                    <div class="input-items">
                                        <div>
                                            <div class="form-group">
                                                <input placeholder="text" type="text" name="workers_name[]" id="request-form">
                                                <label id="request-form">Name </label>
                                            </div>
                                            <div class="form-group">
                                                <input placeholder="text" type="text" name="workers_desc[]" id="request-form">
                                    ...
                                    <div class="input-items">
                                        <div>
                                            <div class="form-group">
                                                <input placeholder="text" type="text" name="material_qty[]" id="request-form">
                                                <label id="request-form">Quantity</label>
                                            </div>
                                            <div class="form-group">
                                                <input placeholder="text" type="text" name="material_desc[]" id="request-form">
                                    ...
                                    <div class="input-items">
                                        <div>
                                            <div class="form-group">
                                                <input placeholder="text" type="text" name="tools_qty[]" id="request-form">
                                                <label id="request-form">Quantity</label>

                                            </div>
                                            <div class="form-group">
                                                <input placeholder="text" type="text" name="tools_desc[]" id="request-form">
                                                <label id="request-form">Description</label>
