...
<script>
	...
	$(function() {
		...
		$(".proceed").click(function() {
			...
			if (value == 'unit-repair') {
				window.location.assign("<?= WEB_ROOT ?>/tenant/form-add-unit-repair");
			} else if (value == 'gate-pass') {
				window.location.assign("<?= WEB_ROOT ?>/tenant/form-add-gate-pass");
			} else if (value == 'visitor-pass') {
				window.location.assign("<?= WEB_ROOT ?>/tenant/form-add-visitor-pass");
			} else if (value == 'reservation') {
				window.location.assign("<?= WEB_ROOT ?>/tenant/form-add-reservation");
			} else if (value == 'move-in') {
				window.location.assign("<?= WEB_ROOT ?>/tenant/form-add-move-in");
			} else if (value == 'move-out') {
				window.location.assign("<?= WEB_ROOT ?>/tenant/form-add-move-out");
			} else if (value == 'work-permit') {
				window.location.assign("<?= WEB_ROOT ?>/tenant/form-add-work-permit");
			}
		});
	});
	...
	$(document).ready(function() {
		...
		// 	window.location.href = "<?= WEB_ROOT ?>/tenant/form-add-service-request";
		// });
			...
			columns: [{
					...
					render: function(data, row) {
						if (row.approve == 0) {
							...
							if (row.sr_type == 'unit-repair') {
								return '<input class="" type="checkbox" id="' + row.id + '" name="check_box" table="unit_repair" view_table="view_unit_repair" reload="<?= WEB_ROOT; ?>/tenant/service-request?submenuid=service_request"> Open';
							} else if (row.sr_type == 'gate-pass') {
								return '<input class="" type="checkbox" id="' + row.id + '" name="check_box" table="gate_pass" view_table="view_gate_pass" reload="<?= WEB_ROOT; ?>/tenant/service-request?submenuid=service_request"> Open';
							} else if (row.sr_type == 'visitor-pass') {
								return '<input class="" type="checkbox" id="' + row.id + '" name="check_box" table="visitor_pass" view_table="view_visitor_pass" reload="<?= WEB_ROOT; ?>/tenant/service-request?submenuid=service_request"> Open';
							} else if (row.sr_type == 'reservation') {
								return '<input class="" type="checkbox" id="' + row.id + '" name="check_box" table="reservation" view_table="view_reservation" reload="<?= WEB_ROOT; ?>/tenant/service-request?submenuid=service_request"> Open';
							} else if (row.sr_type == 'move-in') {
								return '<input class="" type="checkbox" id="' + row.id + '" name="check_box" table="move_in" view_table="view_move_in" reload="<?= WEB_ROOT; ?>/tenant/service-request?submenuid=service_request"> Open';
							} else if (row.sr_type == 'move-out') {
								return '<input class="" type="checkbox" id="' + row.id + '" name="check_box" table="move_out" view_table="view_move_out" reload="<?= WEB_ROOT; ?>/tenant/service-request?submenuid=service_request"> Open';
							} else if (row.sr_type == 'work-permit') {
								return '<input class="" type="checkbox" id="' + row.id + '" name="check_box" table="work_permit" view_table="view_work_permit" reload="<?= WEB_ROOT; ?>/tenant/service-request?submenuid=service_request"> Open';
							}
						} else {
							return "Approved"
							if (row.sr_type == 'unit-repair') {
								return '<input class="" type="checkbox" id="' + row.id + '" name="check_box" table="unit_repair" view_table="view_unit_repair" reload="<?= WEB_ROOT; ?>/tenant/service-request?submenuid=service_request"> Approved';
							} else if (row.sr_type == 'gate-pass') {
								return '<input class="" type="checkbox" id="' + row.id + '" name="check_box" table="gate_pass" view_table="view_gate_pass" reload="<?= WEB_ROOT; ?>/tenant/service-request?submenuid=service_request"> Approved';
							} else if (row.sr_type == 'visitor-pass') {
								return '<input class="" type="checkbox" id="' + row.id + '" name="check_box" table="visitor_pass" view_table="view_visitor_pass" reload="<?= WEB_ROOT; ?>/tenant/service-request?submenuid=service_request"> Approved';
							} else if (row.sr_type == 'reservation') {
								return '<input class="" type="checkbox" id="' + row.id + '" name="check_box" table="reservation" view_table="view_reservation" reload="<?= WEB_ROOT; ?>/tenant/service-request?submenuid=service_request"> Approved';
							} else if (row.sr_type == 'move-in') {
								return '<input class="d-nonetext-center  d-lg-block" type="checkbox" id="' + row.id + '" name="check_box" table="move_in" view_table="view_move_in" reload="<?= WEB_ROOT; ?>/tenant/service-request?submenuid=service_request"> Approved';
							} else if (row.sr_type == 'move-out') {
								return '<input class="k" type="checkbox" id="' + row.id + '" name="check_box" table="move_out" view_table="view_move_out" reload="<?= WEB_ROOT; ?>/tenant/service-request?submenuid=service_request"> Approved';
							} else if (row.sr_type == 'work-permit') {
								return '<input class="" type="checkbox" id="' + row.id + '" name="check_box" table="work_permit" view_table="view_work_permit" reload="<?= WEB_ROOT; ?>/tenant/service-request?submenuid=service_request"> Approved';
							}
						}
					}
				},
				{
					...
					render: function(data, row) {
						...
						if (row.sr_type == 'unit-repair') {
							return '<a href="<?= WEB_ROOT; ?>/tenant/view-unit-repair/' + row.id + '/View" target="_self">' + name + '</a>';
						} else if (row.sr_type == 'gate-pass') {
							return '<a href="<?= WEB_ROOT; ?>/tenant/view-gate-pass/' + row.id + '/View" target="_self">' + name + '</a>';
						} else if (row.sr_type == 'visitor-pass') {
							return '<a href="<?= WEB_ROOT; ?>/tenant/view-visitor-pass/' + row.id + '/View" target="_self">' + name + '</a>';
						} else if (row.sr_type == 'reservation') {
							return '<a href="<?= WEB_ROOT; ?>/tenant/view-reservation/' + row.id + '/View" target="_self">' + name + '</a>';
						} else if (row.sr_type == 'move-in') {
							return '<a href="<?= WEB_ROOT; ?>/tenant/view-move-in/' + row.id + '/View" target="_self">' + name + '</a>';
						} else if (row.sr_type == 'move-out') {
							return '<a href="<?= WEB_ROOT; ?>/tenant/view-move-out/' + row.id + '/View" target="_self">' + name + '</a>';
						} else if (row.sr_type == 'work-permit') {
							return '<a href="<?= WEB_ROOT; ?>/tenant/view-work-permit/' + row.id + '/View" target="_self">' + name + '</a>';
						} else {
							return name;
						}
					}
