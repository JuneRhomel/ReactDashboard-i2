...
try{
	...
	if ($record) {
		...
		// INIT BODY CONTENT
		$body = "<p>We're sending an invite for you to register as Tenant in {$building['location_name']}.</p>
			...
			<p><a href='http://portali2.sandbox.inventiproptech.com/register.php?acctcode=".encryptData($accountcode)."&email={$email}&unit_id={$unit_id}&from={$owner}'>View Link<p>";
