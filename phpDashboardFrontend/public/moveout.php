                ...
                <div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <button type="button" lass="btn primary"><div><i class="fa-solid fa-paperclip text-white"></i></div></button>
                        </div>
