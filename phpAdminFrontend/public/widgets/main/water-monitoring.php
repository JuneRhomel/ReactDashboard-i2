...
<div class="dashboard-footer" style="color:#34495E;text-align:left"><span class="fa fa-dashboard"></span> <label class="text-required" style="font-size: 20px;">Water Monitoring</label></div>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><?= number_format($item->WaterConsumption , 2, '.', ',');   ?></td>
                    </tr>
                <?php
