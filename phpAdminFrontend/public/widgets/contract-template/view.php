    ...
    <div class="col-9">
        <div class="py-4 ps-4 bg-gray">
            <div class="d-flex justify-content-between mb-3">
                <a onclick="location='<?=WEB_ROOT."/$module/"?>'"><label class="data-title" style="cursor:pointer;"><i class="fa-solid fa-arrow-left fa-sm"></i> <?=$record->template?></label></a>
            ...
            <table class="table table-bordered bg-white p-5" width="100%">
                <tr>
                    <td class="p-3 bold" width="30%">Available Fields</td>
                    <td class="p-3" width="70%">
                        <div class="row">
                            <div class="col-md-3"><b>FIELD NAME</b></div>
                            <div class="col-md-9"><b>DISPLAY CODE</b></div>
                            <?php foreach($fields as $val) { ?>
                            <div class="col-md-3"><?=$val->fieldlabel?></div>
                            <div class="col-md-9"><?="[{$val->fieldname}]"?></div>
                            <?php } ?>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td class="p-3 bold" width="30%">Content</td>
                    <td class="p-3" width="70%">
                        <iframe src="<?=API_URL;?>/uploads/<?=$record->accountcode?>/contract_template/<?=$record->id?>.html" title="description" width="100%" height="400px"></iframe>
                    </td>
                </tr>
            </table>            
