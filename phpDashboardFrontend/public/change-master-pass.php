...
<div class="d-flex">
    ...
    <div class="main">
        ...
        <div class="d-flex align-items-center px-3 mt-3">
            ...
            <label class="heading-page px-2 m-0" style="font-weight: 600; font-size: 22px; color: #1C5196;">Change Master Password</label>
        </div>
        <div style="background-color: #F0F2F5;padding: 24px 25px 46px 25px;">
            <form action="change-master-pass-save.php" id="form-main">
                <input type="hidden" name="id" value="<?= $user->id ?>">
                <div style="padding: 24px; background-color: #FFFFFF; border-radius: 5px;">
                    <div class="col-12 px-0">
                        <input id="my-profile" name="old_master_password" type="password"  required>
                        <label id="my-profile">Old Master Password</label>
                    </div>
                    <div class="col-12 mt-3 px-0">
                        <input id="my-profile" name="new_master_password" type="password"  required>
                        <label id="my-profile">New Master Password</label>
                    </div>
                    <div class="col-12 mt-3 px-0">
                        <input id="my-profile" name="confirm_master_password" type="password"  required>
                        <label id="my-profile">Confirm Master Password</label>
                    </div>
		...
		<div class="modal-dialog  modal-dialog-centered" role="document">
			<div class="modal-content px-1 pt-2" style="border-radius: 10px;">
				...
				<div class="modal-body pt-0 text-center" style="padding-bottom: 20px;">
					<h3 class="modal-title align-center text-center" style="font-size: 15px; font-weight: 600;margin-bottom: 29px;">Your successfully change your master password </h3>
