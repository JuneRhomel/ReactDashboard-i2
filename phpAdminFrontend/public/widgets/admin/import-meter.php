<?php
$module = "meter";
$role_table = "import_meter";
$table = "meter";
$view = "vw_meter";
//$error_redirect = "/admin/import-meter/";
//$unique = ['meter Name'=>'meter_name','meter Type'=>'meter_type'];
...
$filename = ($ownership=="SO") ? "SO Meter Template.xlsx" : "HOA Meter Template.xlsx";
?>
