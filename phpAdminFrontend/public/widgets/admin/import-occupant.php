<?php
$module = "resident";
$role_table = "import_resident";
$table = "resident";
$view = "vw_resident";
//$error_redirect = "/admin/import-resident/";
//$unique = ['resident Name'=>'resident_name','resident Type'=>'resident_type'];
...
$filename = ($ownership=="SO") ? "SO Occupant Template.xlsx" : "HOA Occupant Template.xlsx";
?>
...
<?php else: ?>
    ...
    <div class="p-2">
        ...
        <ol>
            ...
            <li>Approve Occupant in Occupant Registration</li>
        </ol>
        <hr>
            ...
            success: function(data){
                if(data.success==1) {
                    popup({
                        data: data,
                        reload_time: 2000,
                        redirect: "<?= WEB_ROOT . "/occupant_registration/" ?>"
                    })
